...
if ($is_edit && $payroll && !empty($payroll->id)) {
    $preview_args['payroll_id'] = (int) $payroll->id;
}
...
<div class="wrap">
    ...
    <div class="tasa-payroll-editor-layout">
        <div class="tasa-payroll-editor-form">
        ...
        <div class="tasa-payroll-editor-preview">
            <h2><?php _e('PDF Preview', 'tasa-payroll'); ?></h2>
            <p id="tasa-payroll-preview-status" class="description"><?php _e('Preview updates automatically as you edit payroll details.', 'tasa-payroll'); ?></p>
            <iframe
                id="tasa-payroll-pdf-preview-frame"
                src="<?php echo esc_url($preview_url); ?>"
                title="<?php esc_attr_e('Payroll PDF Preview', 'tasa-payroll'); ?>"
            ></iframe>
        </div>
    </div>
</div>
